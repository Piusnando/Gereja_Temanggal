                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            ...
                            <!-- Instagram -->
                            <a href="https://www.instagram.com/komsosgsit/" target="_blank" class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-800 hover:bg-linear-to-tr hover:from-yellow-400 hover:via-red-500 hover:to-purple-500 text-white transition duration-300 shadow-md group" title="Instagram">
