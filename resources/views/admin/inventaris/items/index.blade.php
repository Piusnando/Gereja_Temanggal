...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('admin.inventaris.items.create') }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow transition flex items-center">
        ...
        <table class="min-w-full leading-normal">
            ...
            <tbody class="text-gray-700 text-sm divide-y divide-gray-100">
                ...
                <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 mb-6">
                    ...
                    <!-- Tambahkan x-data agar Alpine aktif di area ini -->
                    <form action="{{ route('admin.inventaris.items.index') }}" method="GET" 
                        ...
                        <div class="w-full md:flex-1 relative">
                            <input type="text" 
                                ...
                                {{-- FITUR OTOMATIS (Alpine.js) --}}
                                {{-- Artinya: Saat mengetik, tunggu 1000ms (1 detik), lalu submit form --}}
                                x-on:input.debounce.1000ms="$el.form.submit()"
                                {{-- -------------------------- --}}
                                
                                {{-- UX Tambahan: Fokus otomatis jika sedang mencari --}}
                            ...
                            <!-- Indikator Loading (Opsional: Muncul saat mengetik) -->
                        ...
                        <div class="w-full md:w-auto">
                            ...
                            @else
                                <!-- Tombol Cari Manual (Tetap ada sebagai cadangan) -->
