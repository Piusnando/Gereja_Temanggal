...
<div class="bg-white rounded-lg shadow overflow-hidden border border-gray-100">
    ...
    <div class="hidden md:block">
        {{-- ... Kode tabel desktop lama Anda bisa ditaruh di sini ... --}}
    </div>
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <span class="bg-purple-50 text-purple-700 font-mono px-2 py-0.5 text-xs rounded border">{{ $category->code }}</span>
                        <span class="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full text-xs font-bold">{{ $category->items->count() }} Item</span>
                    </div>
                </div>
                <div class="flex gap-2">
                    <a href="{{ route('admin.inventaris.categories.edit', $category->id) }}" class="p-2 bg-blue-50 rounded"><svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg></a>
