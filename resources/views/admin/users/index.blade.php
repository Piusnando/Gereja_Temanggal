...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <a href="{{ route('admin.users.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow flex items-center transition duration-200">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden border border-gray-200">
        <table class="min-w-full leading-normal">
            <thead class="bg-gray-50 border-b border-gray-200 text-gray-500 uppercase text-xs font-bold tracking-wider">
                <tr>
                    <th class="px-5 py-3 text-left">Nama Pengguna</th>
                    <th class="px-5 py-3 text-left">Email</th>
                    <th class="px-5 py-3 text-left">Role / Hak Akses</th>
            ...
            <tbody class="bg-white divide-y divide-gray-100 text-sm text-gray-700">
                ...
                <tr class="hover:bg-blue-50 transition duration-150">
                    ...
                    <td class="px-5 py-4">
                        ...
                        @endphp
                        <span class="px-3 py-1 font-semibold leading-tight rounded-full text-xs {{ $badgeClass }}">
                            {{ $labelText }}
                        </span>
                    </td>
                    ...
                    <td class="px-5 py-4 text-center">
                        <div class="flex justify-center items-center gap-2">
                            ...
                            <!-- Tombol Hapus (Cek bukan diri sendiri) -->
                            @if(auth()->id() != $user->id)
                            ...
                            @else
                                ...
                                <span class="text-gray-400 text-xs italic px-2 py-1 bg-gray-50 rounded cursor-not-allowed" title="Anda sedang login">Akun Saya</span>
                            @endif
                        </div>
                    </td>
                </tr>
