...
<div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {{-- 7. DASHBOARD BINA IMAN (NEW) --}}
        @if(in_array(Auth::user()->role, ['admin', 'pengurus_gereja', 'omk', 'pia_pir']))
            <a href="{{ route('admin.youth.dashboard') }}" class="group block bg-white rounded-xl shadow-md p-6 hover:shadow-xl hover:-translate-y-1 transition duration-300 border border-gray-100 relative overflow-hidden">
                
                <!-- Hiasan Background (Opsional) -->
                <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-orange-50 rounded-full opacity-50 group-hover:scale-110 transition"></div>
                ...
                <div class="flex items-center justify-between mb-4 relative z-10">
                    <div class="bg-orange-100 text-orange-600 p-3 rounded-lg group-hover:bg-orange-600 group-hover:text-white transition">
                        <!-- Icon User Group / Youth -->
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    </div>
                    <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">Generasi Muda</span>
                </div>
                
                <h3 class="text-xl font-bold text-gray-800 group-hover:text-orange-600 transition relative z-10">
                    Dashboard Bina Iman
                </h3>
                <p class="text-sm text-gray-500 mt-2 relative z-10">
                    Statistik & Data PIA, PIR, dan OMK.
                </p>
            </a>
        @endif
